<%-- 
    Document   : Staff_Registration
    Created on : Sep 1, 2023, 6:29:53 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="Staff_Registration.css">
                    ...
                    <div class="col-lg-5 col-md-10 col-sm-12">
                        <div class="form-box px-5 py-4">
                            <form>
                                ...
                                <input type="text" name="" placeholder="Staff ID" class="form-control mb-3">
                                <input type="text" name="Name" placeholder="Name" class="form-control mb-3">
                                <input type="email" name="email" placeholder="Email" class="form-control mb-3">
                                <input type="text" name="" placeholder="City" class="form-control mb-3">
                                <input type="number" name="" placeholder="Contact No." class="form-control mb-3">
                                <div class="input-group mb-3">
                                    <input type="password" name="" placeholder="Password" class="form-control  border-end-0">
